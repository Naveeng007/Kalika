...
class CreatePost extends React.Component {
    ...
    handleImageAsFile=async(e)=>{
        ...
        console.log('onload outside')
        reader.onload=()=>{
            console.log('onload inside')
            document.getElementById('post-image-file').src=reader.result;
            console.log(document.getElementById('post-image-file'))
        }
        ...
        return(
            <div className="post">
                {this.state.error&&<div className="comment-post" id="error">
                    ...
                    {/* <img id="post-image-file" className="login-image" /> */}
